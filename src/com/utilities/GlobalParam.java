...
//	public static boolean Reporting = true;
	...
	private static void loadMasterProperties(String flavour) { // ##U
		...
		String fileLoc = GlobalParam.CURRENT_PROJECT_PATH + GlobalParam.slash
				+ flavour + ".properties";
		try {
			...
			while (e.hasMoreElements()) {
				...
				if (prop.startsWith("cap_")) {
					...
					if (capName.equals("app"))
						capVal = System.getProperty("user.dir")
								+ GlobalParam.slash + "app" + GlobalParam.slash
								+ capVal;
