...
//					driver = new IOSDriver<MobileElement>(new URL(baseURL), GlobalParam.driverCapabilities);
				driver = new IOSDriver<MobileElement>(new URL("http://" + seleniumServer + ":" + port + "/wd/hub"), GlobalParam.driverCapabilities);
				}	else{
//					driver = new AndroidDriver<MobileElement>(new URL(baseURL), GlobalParam.driverCapabilities);
					driver = new AndroidDriver<MobileElement>(new URL("http://localhost:5566/wd/hub/"), GlobalParam.driverCapabilities);
				}
